...
用于分析感应电机气隙磁密数据，计算饱和系数 **K_sat** 以及相关的磁密比值系数，包括极弧系数 **α_i**、波形系数 **K_Nm** 和绕组系数 **K_W**。通过FFT分析、谐波滤波等数字信号处理技术，提供完整的电机磁密特性分析。
...
- 其中：
  ...
  - 0.4：气隙长度 (mm)
    ...
    电机截面图如下：![电机截面图](output_results/MotorCross-section.png)
...
- 电机自动初始化设计Motor_AID(Automatic Initial Design)的自定义辅助系数,用来计算齿磁密和压降
...
│   ├── ksat_comprehensive.png             # K_sat与α_i、K_Nm、K_W的综合关系图
